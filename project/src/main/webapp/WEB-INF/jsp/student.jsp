...
<button type="submit" class="btn btn-primary" style="margin:10px">登録</button>
</form>


<form action="/project/Update" method="post">
<button type="submit" class="btn btn-primary" style="margin:10px">編集</button>

</form>


<form action="/project/Delete" method="post">
<button type="submit" class="btn btn-primary" style="margin:10px">削除</button>

</form>


<form action="/project/Serch" method="post">
<button type="submit" class="btn btn-primary" style="margin:10px">検索</button>
</form>
